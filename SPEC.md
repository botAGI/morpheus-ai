...
│   │   └── verify.py         # morpheus verify --provenance
...
morpheus verify --provenance    # Full provenance verification
...
- [x] `morpheus init` creates .morpheus/ with config.toml
...
- [x] Tests pass for core modules (19/19)
